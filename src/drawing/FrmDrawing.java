		...
		btnDelete.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if (selectedShape instanceof Rectangle) {
					int confirm = JOptionPane.showConfirmDialog(null,
							"Are you sure you want to delete this rectangle?", "Confirm deletion",
							JOptionPane.YES_NO_OPTION);
					if (confirm == JOptionPane.YES_OPTION) {
						pnlDrawing.getShapes().remove(selectedShape);
						pnlDrawing.repaint();
				...
				if (selectedShape instanceof Donut) {
					int confirm = JOptionPane.showConfirmDialog(null,
							"Are you sure you want to delete this donut?", "Confirm deletion",
							JOptionPane.YES_NO_OPTION);
					if (confirm == JOptionPane.YES_OPTION) {
						pnlDrawing.getShapes().remove(selectedShape);
						pnlDrawing.repaint();
					...
					int confirm = JOptionPane.showConfirmDialog(null,
							"Are you sure you want to delete this circle?", "Confirm deletion",
							JOptionPane.YES_NO_OPTION);
					if (confirm == JOptionPane.YES_OPTION) {
						pnlDrawing.getShapes().remove(selectedShape);
						pnlDrawing.repaint();
