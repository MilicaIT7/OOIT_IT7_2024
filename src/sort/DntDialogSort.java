...
public class DntDialogSort extends JDialog {
	...
	public static void main(String[] args) {
		try {
			DntDialogSort dialog = new DntDialogSort();
	...
	public DntDialogSort() {
		...
		panelTitle.setBackground(new Color(126, 146, 138));
		...
		contentPanel.setBackground(new Color(225, 235, 231));
		contentPanel.setBorder(BorderFactory.createCompoundBorder(
				BorderFactory.createLineBorder(new Color(90, 105, 99), 1),
		...
		buttonPane.setBackground(new Color(225, 235, 231));
		...
		okButton.setBackground(new Color(126, 146, 138));
		...
		cancelButton.setBackground(new Color(126, 146, 138));
